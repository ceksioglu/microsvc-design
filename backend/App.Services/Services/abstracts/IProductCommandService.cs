...
public interface IProductCommandService
{
    ...
    /// <returns>The task result contains the details of the created product.</returns>
    ...
    /// <returns>The task result contains the updated product details.</returns>
    ...
    /// <returns>The task result contains a boolean indicating if the deletion was successful.</returns>
    ...
    /// <returns>The task result contains a boolean indicating if the update was successful.</returns>
